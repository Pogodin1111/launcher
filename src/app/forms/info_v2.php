...
class info_v2 extends AbstractForm
{

    /**
     * @event labelVer.mouseEnter 
     **/
    function doLabelVerMouseEnter(UXMouseEvent $event = null)
    {
        Element::setText($this->labelVer, 'MetroUI Update!');

        // +Actions: 1 //
    }

    /**
     * @event labelVer.mouseExit 
     **/
    function doLabelVerMouseExit(UXMouseEvent $event = null)
    {
        Element::setText($this->labelVer, 'v.1.0a');

        // +Actions: 1 //
    }

    /**
     * @event buttonLog.click-Left 
     **/
    function doButtonLogClickLeft(UXMouseEvent $event = null)
    {
        $this->loadForm('log');
     ...
     **/
    function doButtonCloseClickLeft(UXMouseEvent $event = null)
    {
        app()->hideForm('info_v2');
